                ...
                setTimeout(() => {
                    Coherent.call('GET_FLIGHTPLAN').then(async (data) => {
                        ...
                        if (!isDirectTo) {
                            ...
                            console.log("Setting Origin to in asobo sync: " + data.waypoints[0].icao);
                            ...
                            for (let i = 0; i < enroute.length - 1; i++) {
                                ...
                                if (wpt.icao.trim() !== '') {
                                    ...
                                    const cwpt = WaypointBuilder.fromCoordinates(
                                        'CUST' + i,
                                        wpt.lla,
                                        fpln._parentInstrument
                                    );
    ...
    public static async SaveToGame(fpln: FlightPlanManager): Promise<void> {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (plan.hasOrigin && plan.hasDestination) {
                ...
                await Coherent.call('SET_ORIGIN_RUNWAY_INDEX', plan.procedureDetails.originRunwayIndex).catch(
                    console.log
                );
                ...
                await Coherent.call(
                    'SET_ARRIVAL_ENROUTE_TRANSITION_INDEX',
